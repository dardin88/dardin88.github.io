...
var skel = function () {
    var e = "breakpoints", t = "config", n = "iterate", r = "elements", i = "stateId", s = "stateElements", o = "getElementsByClassName", u = !1, a = "getElementsByTagName", f = "length", l = null, c = "getCachedElement", h = "viewport", p = " 0 -1px ", d = "cacheNewElement", v = "config_breakpoint", m = !0, g = "createElement", y = "gutters", b = "vars", w = "insertBefore", E = "newInline", S = "}", x = "cache", T = "parentNode", N = "orientationChange", C = "substring", k = "locations", L = "deviceType", A = "className", O = " 0 0 ", M = "object", _ = "isArray", D = "match", P = "+*,", H = "replace", B = "head", j = "newElement", F = "canUseProperty_element", I = "indexOf", q = "_skel_isReversed", R = "push", U = "extend", z = "grid", W = "matchesMedia", X = "containers", V = "maxGridZoom", $ = "onorientationchange", J = "defaults", K = "DOMReady", Q = "lock", G = "getComputedStyle", Y = "addEventListener", Z = "^head", et = "{display:none!important}", tt = "registerLocation", nt = "parseMeasurement", rt = "documentElement", it = "placeholder", st = "events", ot = "IEVersion", ut = "attachElements", at = "charAt", ft = "plugins", lt = "attachElement", ct = "isActive", ht = "DOMContentLoaded", pt = "text/css", dt = "device-width", vt = "states", mt = "_skel_attach", gt = "initial-scale=1", yt = "trigger", bt = "removeEventListener", wt = "previousSibling", Et = "media", St = "resize", xt = "attached", Tt = "normalize", Nt = "applyRowTransforms", Ct = "collapse", kt = "change", Lt = "location", At = "(min-width: ", Ot = "split", Mt = "forceDefaultState", _t = "style", Dt = "html", Pt = "_skel_placeholder", Ht = "firstChild", Bt = "querySelectorAll", jt = "min-height", Ft = "max-height", It = "innerHTML", qt = "min-width", Rt = "prototype", Ut = "max-width", zt = "domready", Wt = "hasOwnProperty", Xt = "nextSibling", Vt = "height=", $t = "zoom", Jt = "href", Kt = "isStatic", Qt = "android", Gt = "readyState", Yt = ".\\3$1 ", Zt = "onresize", en = "priority", tn = {
        ...
        config: {
            ...
            defaultState: l,
            events: {},
            grid: {zoom: 1, collapse: u, gutters: [40, 0]},
            lock: {path: u, permanent: m},
            plugins: {},
            pollOnce: u,
            preload: u,
            reset: Tt,
            RTL: u,
            viewport: {width: dt, height: "", scalable: m}
        },
        css: {
        ...
        defaults: {
            breakpoint: {config: l, elements: l, test: l},
            config_breakpoint: {containers: "100%", grid: {}, href: u, media: "", viewport: {}}
        },
        events: [],
        forceDefaultState: u,
        isInit: u,
        isStatic: u,
        locations: {body: l, head: l, html: l},
        lcn: "_skel_lock",
        maxGridZoom: 1,
        me: l,
        plugins: {},
        ...
        canUseProperty: function (e) {
            ...
            var t = tn[F][_t], n = e[at](0).toUpperCase() + e.slice(1);
        ...
        applyRowTransforms: function (e) {
            ...
            var r = "_skel_important", i = [], s, a;
            for (s = 1; s <= tn[V]; s++)
                a = tn[o]("important(" + s + ")"), tn[n](a, function (e) {
                    i[R](a[e])
                });
            a = tn[o]("important(collapse)"), tn[n](a, function (e) {
                ...
                if (!s[Wt](r) || s[r] === u) {
                    ...
                    while (a && a.nodeName == "#text")
                        a = a[c];
                    if (!a)
                        return;
                    o[w](s, tn[t].RTL && l == "z" ? o.lastChild : o[Ht]), s[r] = {placeholder: a, mode: l, zoom: h}
                } else {
                    a = s[r][it], l = s[r].mode;
                    if (l == "c" && e[t][z][Ct] || l == "z" && s[r][$t] <= e[t][z][$t])
                        return;
        ...
        newElement: function (e, t, n, r) {
            return {id: e, object: t, location: n, priority: r, attached: u}
        },
        ...
        getStateId: function () {
            if (tn[Mt] && tn[t].defaultState)
                return tn[t].defaultState;
            var r = "";
        ...
        initConfig: function (i) {
            var s = [], o = [];
            if (!i || !(e in i))
                tn[Kt] = m, tn[t][h].width = "", tn[t][h].height = "", tn[t][h].scalable = m;
            typeof i == M && (i[e] && (tn[t][e] = {}), tn[U](tn[t], i)), z in tn[t] && y in tn[t][z] && !tn[_](tn[t][z][y]) && (tn[t][z][y] = [tn[t][z][y], tn[t][z][y]]), tn[U](tn[J][v][z], tn[t][z]), tn[V] = Math.max(tn[V], tn[t][z][$t]), tn[U](tn[J][v][h], tn[t][h]), tn[J][v][X] = tn[t][X], tn[n](tn[t][e], function (n) {
                ...
                var e, t = document[a](B)[0], r = new XMLHttpRequest;
                tn[n](o, function (e) {
        ...
        initUtilityMethods: function () {
            document[Y] ? !function (e, t) {
                ...
                var t = [], n, r = document, i = ht, s = /^loaded|^c/.test(r[Gt]);
                ...
                var n = [], r, i = !1, s = document, o = s[rt], u = o.doScroll, a = ht, f = Y, l = "onreadystatechange", c = Gt, h = u ? /^loaded|^c/ : /^loaded|c/, p = h.test(s[c]);
                ...
                if (e == "")
                    return m;
                var t = document[g](_t), n = document[a]("script")[0], r = l;
                ...
                if (e == "")
                    return m;
                var t, n, r, i, s = {"min-width": l, "max-width": l}, o = u;
                n = e[Ot](/\s+and\s+/);
                for (i in n)
                    t = n[i], t[at](0) == "(" && (t = t[C](1, t[f] - 1), r = t[Ot](/:\s+/), r[f] == 2 && (s[r[0][H](/^\s+|\s+$/g, "")] = parseInt(r[1]), o = m));
                if (!o)
                    return u;
                var a = document[rt].clientWidth, c = document[rt].clientHeight;
    ...
    return tn.preInit(), tn[b][ot] < 9 && (tn[Nt] = function (e) {
    }, tn[E] = function (e) {
        var t;
